...
let
  mdadmconf = ''
    ...
    ARRAY /dev/md/atle-station:0 metadata=1.2 name=atle-station:0 UUID=69e33663:d1a088c1:ac0a7739:1d05b0d7
  '';
in
{
  systemd.services.mdadm-monitor = {
    ...
    script = "${pkgs.mdadm}/bin/mdadm --monitor /dev/md/atle-station:0";
  };
